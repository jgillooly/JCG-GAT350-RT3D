...
namespace nc
{
	...
	bool Model::Load(const std::string& filename, const glm::vec3& translation, const glm::vec3& rotation, const glm::vec3& scale)
	{
		...
		glm::mat4 mt = glm::translate(translation);
